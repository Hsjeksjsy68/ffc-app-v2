...
// Fix: Export all icon components so they can be imported and used in other files like AdminPage.tsx.
...
export const AdminLoginIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const TrainingIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
    </svg>
);

export const UsersAdminIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const NAV_LINKS: NavLink[] = [
    ...
    { name: 'Messaging', icon: ChatIcon },
    { name: 'Players', icon: UsersIcon },
    { name: 'Player Login', icon: LoginIcon },
    { name: 'Admin Login', icon: AdminLoginIcon },
];

export const ADMIN_NAV_LINK: NavLink = { name: 'Admin', icon: AdminIcon };

export const LOGOUT_NAV_LINK: NavLink = { name: 'Logout', icon: LogoutIcon };